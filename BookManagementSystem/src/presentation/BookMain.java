			...
			while(ch == 'y') {
				...
				switch(option) {
					...
					case 2:
						...
						System.out.println("Book Title : " +  fetchedOldBook.getBookId());
					...
					case 3:
						...
						System.out.println("Book Title : " +  fetchedBook.getBookId());
					...
					case 4:
						...
						while(itr.hasNext()) {
							...
							System.out.println(book.getBookId() + "\t" + book.getBookId() + "\t" + book.getBookAuthor() + "\t" + book.getBookGenre() + "\t" + book.getBookCost());
						}
						System.out.println("**************************************************************************************");
						break;
					case 5:
